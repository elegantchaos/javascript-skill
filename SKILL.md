...
5. If framework-specific behavior is central to the task, treat the relevant specialist skill or project guidance as the source of truth and use this skill only for residual baseline JavaScript or TypeScript questions.
